...
export default function WatchVideo() {
  ...
  useEffect(() => {
    // Set page metadata
    document.title = 'Watch Video on Lykluk';
      ...
      <div className={styles.content}>
        ...
        <div className={styles.videoInfo}>
          ...
          <p className={styles.description}>
            This video is best viewed in the Lykluk app.
          </p>
        </div>
        ...
        <div className={styles.downloadSection}>
          ...
          <p className={styles.downloadText}>
            Get the app to watch this video and discover amazing content from creators around the world.
          </p>
